...
for idata = 1 : nData       
    ...
    imsize = size(img);
    cx = Data{idata}.centerx;
    cy = Data{idata}.centery;
    ...
    if ( current_cascade == 1 )        
        ...
        for ir = 1 : n_init_randoms
            ...
            initProjection = CalKeyProj(reconShape, init_trans, all_key,cx,cy);
            
            if 0
                groundShape = Reconstruct_face(BFMmodel, true_para, trans);
                gtProjection = CalKeyProj(groundShape, trans, all_key, cx,cy);
        ...
        for ir = 1 : n_init_randoms
            ...
            initProjection = CalKeyProj(reconShape, trans, all_key, cx,cy);
